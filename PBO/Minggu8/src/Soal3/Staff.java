...
public class Staff {
	StaffMember[] staffList;
		...
		public Staff() {
			...
			staffList[6] = new Commission("Papski Dalhats", "Jl. Jalan Sekitar Taman", "555-0470", "958-47-7777", 6.25, 0.2);
			staffList[7] = new Commission("Mamski Dinda", "Komplek Perumahan Bumi Kita", "555-0202", "958-47-3654", 9.75, 0.15);
